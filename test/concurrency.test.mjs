...
test.skip("two processes, one data dir: every carton and every packed line survives", async (t) => {
...
test.skip("two processes raising packing lists at once never reuse a PL number", async (t) => {
